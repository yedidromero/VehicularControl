...
const Home = () => {
    ...
    return (
                ...
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div className="hidden md:flex fixed left-0 top-0 h-full bg-white w-48 flex-col justify-between border-r-2" style={{ marginTop: '17vh', backgroundColor: 'white', height: '50%' }}>
                    <div className="mt-10 ml-4 flex flex-col text-color-black">
                    <a href="/" className="flex items-center text-gray-900 hover:bg-yellow-300 hover:text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">
                            
                            Datos relevantes
                        </a>
                        <a href="/automovil" className="flex items-center text-gray-900 hover:bg-yellow-300 hover:text-white rounded-md px-3 py-2 text-sm font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4z"/>
                            </svg>
                            Automóvil
                        </a>
                        <a href="/transportista" className="flex items-center text-gray-900 hover:bg-yellow-300 hover:text-white rounded-md px-3 py-2 text-sm font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
                            </svg>
                            Transportista
                        </a>
                        <a href="/agencia" className="flex items-center text-gray-900 hover:bg-yellow-300 hover:text-white rounded-md px-3 py-2 text-sm font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M3.05 3.05a7 7 0 0 0 0 9.9.5.5 0 0 1-.707.707 8 8 0 0 1 0-11.314.5.5 0 0 1 .707.707m2.122 2.122a4 4 0 0 0 0 5.656.5.5 0 1 1-.708.708 5 5 0 0 1 0-7.072.5.5 0 0 1 .708.708m5.656-.708a.5.5 0 0 1 .708 0 5 5 0 0 1 0 7.072.5.5 0 1 1-.708-.708 4 4 0 0 0 0-5.656.5.5 0 0 1 0-.708m2.122-2.12a.5.5 0 0 1 .707 0 8 8 0 0 1 0 11.313.5.5 0 0 1-.707-.707 7 7 0 0 0 0-9.9.5.5 0 0 1 0-.707zM10 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0"/>
                            </svg>
                            Agencia vendedora
                        </a>
                        <a href="/propietario" className="flex items-center text-gray-900 hover:bg-yellow-300 hover:text-white rounded-md px-3 py-2 text-sm font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <a href="/historial" className="flex items-center text-gray-900 hover:bg-yellow-300 hover:text-white rounded-md px-3 py-2 text-sm font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M1.5 1a.5.5 0 0 0-.5.5v3a.5.5 0 0 1-1 0v-3A1.5 1.5 0 0 1 1.5 0h3a.5.5 0 0 1 0 1zM11 .5a.5.5 0 0 1 .5-.5h3A1.5 1.5 0 0 1 16 1.5v3a.5.5 0 0 1-1 0v-3a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 1-.5-.5M.5 11a.5.5 0 0 1 .5.5v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 1 0 1h-3A1.5 1.5 0 0 1 0 14.5v-3a.5.5 0 0 1 .5-.5m15 0a.5.5 0 0 1 .5.5v3a1.5 1.5 0 0 1-1.5 1.5h-3a.5.5 0 0 1 0-1h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 1 .5-.5"/>
                            <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm8-9a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
                            </svg>
  ...
  <div className="flex items-center justify-center mb-2" >
    ...
    <div class="mb-4">
      <label class="block text-white text-sm font-bold mb-2" for="correo">Correo electrónico:</label>
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="correo" type="email" placeholder="Correo electrónico" name="correo" required/>
    </div>
    <div class="mb-4">
      <label class="block text-white text-sm font-bold mb-2" for="wallet">Wallet de Solana:</label>
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="wallet" type="text" placeholder="Wallet de Solana" name="wallet" required/>
    </div>
    <div class="mb-4">
      <label class="block text-white text-sm font-bold mb-2" for="telefono">Teléfono:</label>
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="telefono" type="tel" placeholder="Teléfono" name="telefono" required/>
    </div>
    <div class="mb-4">
      <label class="block text-white text-sm font-bold mb-2" for="pago">Pago:</label>
      <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="pago" name="pago">
        <option value="normal">Pago Normal ($20 USD)</option>
        <option value="bonk">Pago con Bonk (10% de descuento)</option>
      </select>
    </div>
    <div class="mb-6">
